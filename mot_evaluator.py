...
class FrameMetrics:
    ...
    num_gt: int = 0  # Ground Truth数量
    num_det: int = 0  # 检测数量
    matched_ious: List[float] = field(default_factory=list)  # 匹配框的IoU值
...
if __name__ == "__main__":
    ...
    # 测试评估器
    gt_file = "MOT17-02-DPM/gt/gt.txt"
